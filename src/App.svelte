...
<main
    class="min-h-screen flex flex-col items-center justify-center bg-gray-100 dark:bg-gray-900 py-10 transition-colors duration-200"
>
    <div class="w-full max-w-4xl px-4 flex justify-between items-center mb-8">
    ...
    <div class="w-full max-w-4xl mb-8 px-4">
